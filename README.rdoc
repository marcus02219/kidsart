...
==== Change Album name
    ...
    results:
      return album id
    ex: curl -X PUT -H "Content-Type: application/json" http://localhost:3000/api/v1/albums/change_name -d '{"token":"23xdaXnjRexaPyfqDsXs","name":"album5", "album_id":"5746edee8b1fcf079c000000"}'
==== Delete Album
...
==== Upload Photo
  ...
  ex:
    curl \
      -F "token=23xdaXnjRexaPyfqDsXs" \
      -F "album_id=5746edf58b1fcf079c000001" \
      -F "name=ttt" \
